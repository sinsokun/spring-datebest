...
public interface ProductRepository {
    ...
    @Results(id = "productResultMap", value ={
            ...
            @Result(property = "categories" , column = "id",
                    many = @Many(select = "co.istad.sb4webmvc.repossitory.CategoryRepository.selectProductCategories")),
            @Result(property = "supplier",column = "supplier_id",
                    one = @One( select= "co.istad.sb4webmvc.repossitory.SupplierRepository.selectProductSupplier"))
    })
